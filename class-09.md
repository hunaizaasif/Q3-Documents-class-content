...
* **Responses API (Stateful)**: This is like an ongoing conversation. The API manages the chat history and state for you. You can simply send the next message, and it remembers the context of what was said before. (just don't forgot to provide `previous_response_id` in Runner.run)

~~------------------------------~~

## 📗 Class Resources 

* **Panaverse Repo (Advanced Tools)**: https://github.com/panaversity/learn-agentic-ai/tree/main/01_ai_agents_first/15_advanced_tools
* **Today's Class Code**: https://github.com/syeda-hoorain-ali/giaic-q3/tree/main/class-16
* 
